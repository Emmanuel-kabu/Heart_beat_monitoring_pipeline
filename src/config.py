...
class DataQualityConfig:
    ...
    enabled: bool = field(
        default_factory=lambda: _get_env("DQ_ENABLED", "true").lower() == "true"
    )
    max_retries: int = field(
        default_factory=lambda: _get_env_int("DQ_MAX_RETRIES", 3)
    )
